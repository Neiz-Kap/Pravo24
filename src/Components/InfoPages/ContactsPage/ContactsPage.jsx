    ...
    <main>
        ...
        <Card className="text-white h-100">
          ...
          <Card.ImgOverlay>
            <Container fluid className="position-relative w-100 h-100">
              <Breadcrumb>
                <Breadcrumb.Item className="content-link" href="/">
                  Главная
                </Breadcrumb.Item>
              ...
              <Card.Title className="contacts-content__title d-flex align-items-center position-absolute t-50">
        ...
        <Container className="d-flex justify-content-center">
          <Form className="contacts-form d-flex flex-column align-items-center">
            ...
            <h3 className="contacts-form__subtitle text-center">
              Заполните, пожалуйста, форму и наш менеджер свяжется с вами в
              течение дня
            </h3>
            <Form.Group>
              <Form.Control
                className="contacts__input placeholder-center"
            ...
            <Form.Group className="mb-4 d-flex justify-content-center">
              <textarea
                className="contacts__input placeholder-center contacts__input--size-middle"
            ...
            <Button
              variant="primary"
              type="submit"
              className="contacts-form__button btn-lg btn-warning"
            >
              Отправить
            </Button>
          </Form>
      ...
      <section>
        <Container className="d-flex flex-column align-items-center">
          <h2 className="contacts__title mt-3 mb-4 text-center">
          ...
          <ListGroup className="contacts-list">
            ...
            <ListGroup.Item className="w-100 d-flex mb-3">
              ...
              <h5 className="contacts-info__title text-nowrap">
                Facebook Community{" "}
              </h5>
            </ListGroup.Item>
            <ListGroup.Item className="w-100 d-flex mb-3">
