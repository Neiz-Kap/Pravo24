                ...
                <header class="header-w">
                    <div class="max_width">
                        ...
                        <div class="header__contacts geocountry--Ukraine">
                            <div class="header__main-phone"><a href="tel:+380443793062">+38 044 379-30-62</a> КИЕВ</div>
                            <div class="header__buttons">
                                <a href="#"
                                    class="bub24-web-form-popup-btn-4 b24-web-form-popup-btn-10 b24-web-form-popup-btn-12"
                                    onclick="fbq('track', 'Purchase', { value: '0.00', currency: 'USD' }); dataLayer.push({ 'event': 'ButtonRequest', 'analytics_action': 'Zakazat' }); window.yaCounter43176944 ? yaCounter43176944.reachGoal('order_phone') : '';">Заказать
                                    звонок</a>
                                <div class="buttons__more-phones">все офисы</div>
                            </div>
                            <div class="header__more-phones m_hidden">
                                <div><a href="tel:+380443793062">+38 044 379-30-62</a> КИЕВ</div>
                                <div><a href="tel:+420228881658">+420 228-881-658</a> ПРАГА</div>
                                <div><a href="tel:+3726104206">+372 610-42-06</a> ТАЛЛИНН</div>
                                <div><a href="tel:+74991120569">+7 499 112-05-69</a> МОСКВА</div>
                    ...
                    <ul class="lng ulclear">
                        ...
                        <li><a href="/en/parthners/" class="nounderline">en</a></li>
                    </ul>
                </header>
        </body>
    </>
